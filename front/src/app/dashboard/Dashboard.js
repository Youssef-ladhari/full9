        ...
        <div className="proBanner">
          <div>
            <span className="d-flex align-items-center purchase-popup">
              <p>Get our application for more feature !</p>
              <a href="#">Check our app</a>
              ...
              <div className="card-body py-0 px-0 px-sm-3">
                <div className="row align-items-center">
                  ...
                  <div className="col-5 col-sm-7 col-xl-8 p-0">
                    ...
                    <p className="mb-0 font-weight-normal d-none d-sm-block">Our template now with a new feature of to do list!</p>
                  </div>
                  <div className="col-3 col-sm-2 col-xl-2 pl-0 text-center">
                    <button className="btn btn-outline-light btn-rounded get-started-btn" href="#">Get Started</button>
                  </div>
                </div>
              </div>
            </div>
