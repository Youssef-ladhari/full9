...
export class Addregime extends Component {
  state = {
    startDate: new Date()
  };
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Ajout Regime </h3>
              ...
              <div className="card-body">
                ...
                <form className="forms-sample">
                  <Form.Group>
                    ...
                    <Form.Control type="text" id="exampleInputUsername1" placeholder="Identifiant du patient" />
                  </Form.Group>
                  <Form.Group>
                  ...
                  <label htmlFor="exampleInputEmail1">Nom de votre regime</label>
                    <Form.Control type="text" className="form-control" id="exampleInputEmail1" placeholder="Nom de votre regime" />
                  </Form.Group>
                  <Form.Group>
                  <label htmlFor="exampleInputEmail1">Age</label>
                    <Form.Control type="" className="form-control" id="exampleInputEmail1" placeholder="Age" />
                  </Form.Group>
                  <Form.Group>
                  <label htmlFor="exampleInputEmail1">Telephone</label>
                    <Form.Control type="email" className="form-control" id="exampleInputEmail1" placeholder="Telephone" />
                  </Form.Group>
                
                 
                  <Form.Group>
                  <label htmlFor="exampleInputEmail1">Maladie</label>
                    <Form.Control type="email" className="form-control" id="exampleInputEmail1" placeholder="Maladie" />
                  </Form.Group>
